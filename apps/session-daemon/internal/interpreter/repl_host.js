...
try {
  ...
  emit({ type: 'error', name: 'HostBootError', value: 'isolated-vm not installed: ' + err.message })
  process.exit(1)
}
...
try {
  ...
  emit({ type: 'error', name: 'HostBootError', value: 'esbuild-wasm not installed: ' + err.message })
  process.exit(1)
}
